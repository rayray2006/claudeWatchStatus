...
lines: list[str] = [
    ...
    "    }",
    "",
    "    /// True if we're running inside the widget extension process. The bundle",
    "    /// id of the widget extension ends in `.widget`; the main app and NSE",
    "    /// have their own ids.",
    ...
    "    }()",
    "",
    "    /// CGImage per state. Used by the Image render path (main app, NSE).",
