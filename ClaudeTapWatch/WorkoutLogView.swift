...
/// Inspector for the workout-keep-alive event log.
struct WorkoutLogView: View {
    @State private var events: [WorkoutEvent] = []
    ...
    var body: some View {
        ...
        .onAppear { events = WorkoutEventLog.all() }
    }
}
...
private struct EventRow: View {
    ...
    private var color: Color {
        ...
        case .stateChange:              return .green
        case .manualStop:               return .orange
