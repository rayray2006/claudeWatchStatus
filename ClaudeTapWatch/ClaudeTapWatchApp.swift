...
final class ExtensionDelegate: NSObject, WKApplicationDelegate {
    ...
    func applicationDidBecomeActive() {
        ...
        // on. Both must be re-armed from foreground if they died in background
        // (Apple constraint). Either or both may be active.
        KeepAliveManager.shared.resumeIfEnabled()
        LocationKeepAliveManager.shared.resumeIfEnabled()
    }
